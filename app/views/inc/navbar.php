     ...
     <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto dropdown">
       <?php if (isset($_SESSION['valid_actor'])) : ?>
         ...
         <?php if ($_SESSION['valid_actor'] == 'owner') : ?>
           <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo URLROOT; ?>/owners/viewStaff">Staff</a>
           <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo URLROOT; ?>/owners/viewServices">Service</a>
           <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo URLROOT; ?>/owners/viewFaqs">FAQ</a>
         <?php elseif ($_SESSION['valid_actor'] == 'customer') : ?>
           <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo URLROOT; ?>/customers/viewOrders">Order</a>
           <a class="me-3 py-2 text-dark text-decoration-none" href="#">Account</a>
           <a class="me-3 py-2 text-dark text-decoration-none" href="#">FAQ</a>
         <?php elseif ($_SESSION['valid_actor'] == 'staff') : ?>
           <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo URLROOT; ?>/staffs/viewOrders">Order</a>
           <a class="me-3 py-2 text-dark text-decoration-none" href="#">FAQ</a>
         <?php endif; ?>
       ...
       <!-- drop down -->
       <div class="dropdown">
         <a class="btn btn-warning dropdown-toggle" data-bs-toggle="<?php if (isset($_SESSION['valid_actor'])) : echo 'dropdown';
                                                                    else : echo '#';
