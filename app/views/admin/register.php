...
<header class="pb-3 mb-4 border-bottom" style="margin-top:10px">
    <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">Daftar Pentadbir</span>
    </a>
</header>
<div class="form-container" style="padding-left: 25%;padding-right:25%">
    ...
    <form action="<?php echo URLROOT; ?>/admins/register" method="POST" >
        <div class="mb-3">
            ...
            <?php endif ?>
            <div id="emailHelp" class="form-text">Nama pentadbir hendaklah mengandungi sekurang-kurangnya satu huruf besar dan satu nombor</div>
        </div>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-outline-secondary">Daftar Pentadbir</button>
        <small class="text-muted">Pentadbir sedia ada? <a href="<?php echo URLROOT; ?>/admins/login">Log masuk</a></small>
    </form>
</div>
