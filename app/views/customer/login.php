...
<div class="form-container" style="padding-left: 25%;padding-right:25%">
    ...
    <br>
    <?php flash('customer_register_success');  ?>
    <form action="<?php echo URLROOT; ?>/customers/login" method="POST" >
        ...
        <button type="submit" class="btn btn-outline-secondary">Masuk</button> <br>
        <small class="text-muted"> <a href="<?php echo URLROOT; ?>/customers/register">Pengguna baharu?</a></small>
    </form>
</div>
